...
console.log('%cDATA', 'color: purple', data)
	...
	// !!! уточнить размеры выпадающего списка
	return (
		<div className="relative inline-block text-left w-[16rem]">
			<div>
				<button
			...
			{isOpen && (
				<div
					className="origin-top-right absolute right-0 mt-2 w-[16rem]  
					...
					<div className="" role="none">
						{
							data.map((item) => {
								...
								return <p
									...
									className="block px-1 py-1 text-sm text-gray-700 hover:bg-gray-100 pl-5 cursor-pointer" role="menuitem">
									{item}
								</p>
							})
						}
