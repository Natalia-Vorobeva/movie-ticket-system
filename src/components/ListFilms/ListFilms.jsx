function ListFilms({ handleClickFilms, ticket, films, selectFilmModal, setSelectFilmModal }) {
	...
	return (
		<div className="flex-1 text-[1.8rem]">
			{
				selectFilmModal ?
					<div className="absolute z-10 inset-0 pt-2 w-[100%] text-[1rem] min-h-full bg-night flex flex-col text-[.5rem] p-1 rounded-md">
			...
			<div className="pb-[1rem]">
				...
				<div className="relative z-1">
					<p onClick={() => setSelectFilmModal(true)}
						className="relative z-1 text-orangred pt-[1rem] cursor-pointer text-[1.5rem] italic">{ticket ? "ВАШ БИЛЕТ:" : "Больше..."}</p>
				</div>
			</div>
		</div>
	)
